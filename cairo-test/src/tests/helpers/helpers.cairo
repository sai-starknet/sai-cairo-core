...
use sai::world::{IWorldDispatcher, WorldStorage, WorldStorageTrait};
use sai::model::Model;
...
pub mod foo_invalid_name {
    use sai::model::IModel;

    #[storage]
    struct Storage {}

    #[abi(embed_v0)]
    pub impl DeployedModelImpl of sai::meta::IDeployedResource<ContractState> {
    ...
    #[abi(embed_v0)]
    pub impl StoredModelImpl of sai::meta::interface::IStoredResource<ContractState> {
        ...
        fn schema(self: @ContractState) -> sai::meta::introspect::Struct {
            sai::meta::introspect::Struct { name: 'foo', attrs: [].span(), children: [].span() }
        }
    }
...
pub mod bar {
    ...
    use sai::model::{ModelStorage, ModelPtr};
