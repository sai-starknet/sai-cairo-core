...
use sai::world::{IWorldDispatcher, IWorldDispatcherTrait, Resource};
                ...
                match r {
                    ...
                    TestResource::Contract(name) => {
                        let ch: ClassHash = *declare(name.clone())
                            ...
                            .contract_class()
                            .class_hash;
                        let salt = sai::utils::bytearray_hash(name);
...
impl WorldTestExtImpl of WorldTestExt {
    fn resource_contract_address(
        ...
        match self.resource(sai::utils::selector_from_names(@namespace, @name)) {
